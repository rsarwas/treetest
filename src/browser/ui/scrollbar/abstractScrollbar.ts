...
import * as DomUtils from '../../../browser/dom';
import { IMouseEvent, StandardMouseWheelEvent } from '../../../browser/mouseEvent';
import { GlobalMouseMoveMonitor, IStandardMouseMoveEventData, standardMouseMoveMerger } from '../../../browser/globalMouseMoveMonitor';
import { Widget } from '../../../browser/ui/widget';
import { FastDomNode, createFastDomNode } from '../../../browser/fastDomNode';
