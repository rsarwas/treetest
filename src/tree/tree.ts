...
import Touch = require('../browser/touch');
import Mouse = require('../browser/mouseEvent');
import Keyboard = require('../browser/keyboardEvent');
import { INavigator } from '../common/iterator';
import { ScrollbarVisibility } from '../common/scrollable';
import Event from '../common/event';
import { IAction, IActionItem } from '../common/actions';
import { Color } from '../common/color';
import { IItemCollapseEvent, IItemExpandEvent } from './treeModel';
...
export interface ITree {
	 ...
	 */
	refresh(element?: any, recursive?: boolean): Promise;
	 ...
	 */
	toggleExpansion(element: any, recursive?: boolean): Promise;

	/**
	 * Toggles several element's expansion state.
	 */
	toggleExpansionAll(elements: any[]): Promise;
	 ...
	 */
	reveal(element: any, relativeTop?: number): Promise;
